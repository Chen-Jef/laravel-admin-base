...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 每一个laravel-admin扩展对应的配置，都写在这下面
    | 扩展可以参考 https://github.com/laravel-admin-extensions
    |
    */
    'extensions' => [
      	//中国省市区三级联动选择组件  https://github.com/laravel-admin-extensions/china-distpicker
		'china-distpicker' => [
            // 如果要关掉这个扩展，设置为false
            'enable' => true,
        ],
        ...
        'cropper' => [
      	...
      	//汉化面包屑导航  https://github.com/xiaoxuan6/laravel-admin-breadcrumb
        'breadcrumb' => [
          	// 如果要关掉这个扩展，设置为false
            'enable' => false,
     	],
